...
{
    public static class FaceReactionFunction
    {
        [FunctionName("FaceReactionFunction")]
            ...
            ILogger log)
        {
            ...
            {
                conn.Open();
                var text = @"INSERT INTO dbo.FaceReaction (Source, FaceID, Gender, Age, Emotion, Glasses, EyeMakeup, LipMakeup, Beard, Bald, HairColor) 
                     VALUES (@Source, @FaceID, @Gender, @Age, @Emotion, @Glasses, @EyeMakeup, @LipMakeup, @Beard, @Bald, @HairColor)";
                ...
                using (var cmd = new SqlCommand(text, conn))
                {
                    ...
                    cmd.Parameters.AddWithValue("@EyeMakeup", data.EyeMakeup.ToString());
                    cmd.Parameters.AddWithValue("@LipMakeup", data.LipMakeup.ToString());
